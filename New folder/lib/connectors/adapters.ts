        ...
        [
          ...
          },
          {
            ...
            evidence: [
              ...
              "Warehouse pressure is a common hidden cause during concurrent workloads.",
            ],
          },
          {
    ...
    runDiagnostic(connection, action) {
      ...
      if (action === "query") {
        return {
          ...
          evidence: [
            ...
            "Useful queries include table inventory, row counts, task failures, copy history, and warehouse load pressure.",
          ],
        };
      }
      ...
      return {
        ...
        evidence: [
          ...
          "Snowflake currently has the deepest live read path in this workspace.",
        ],
      };
    },
      ...
      return buildGenericInspect(
        ...
        [
          ...
          },
          {
            ...
            evidence: [
              "Content validation is one of the strongest semantic-layer signals here.",
    ...
    runDiagnostic(connection, action) {
      ...
      if (action === "query") {
        return {
          ...
          evidence: [
            `Looker host: ${baseUrl}`,
            "Useful reads include dashboards, content validation, scheduled plans, folders, explores, and query-task metadata.",
      ...
      return buildGenericInspect(
        ...
        [
          ...
          },
          {
            ...
            evidence: [
              "Changed notebook paths and repo drift are common breakage causes.",
    ...
    runDiagnostic(connection, action) {
      ...
      if (action === "query") {
        return {
          ...
          evidence: [
            `Workspace: ${host}`,
            "Useful reads include jobs, runs, clusters, SQL warehouses, workspace assets, and run-output APIs.",
      ...
      if (action === "query") {
        return {
          ...
          evidence: [
            ...
            "Useful reads include dashboards, charts, datasets, databases, audit logs, and recent activity.",
